...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { concepto_de_pago: @movement.concepto_de_pago, date: @movement.date, detail: @movement.detail, reference: @movement.reference } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { concepto_de_pago: @movement.concepto_de_pago, date: @movement.date, detail: @movement.detail, reference: @movement.reference } }
